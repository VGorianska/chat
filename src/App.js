...
import { Avatar, Button, Card, CardActions, CardContent, CardMedia, IconButton, TextField, Typography } from '@mui/material';
import io from 'socket.io-client';
import { AddReactionOutlined, AttachFileOutlined, SettingsOutlined, Send } from '@mui/icons-material';
export default function chatCard() {
  const messages = [{ name: "AJ", text: "Hallo!", time: "10:15" }];
  ...
  return (
    <Card sx={{
      ...
      <CardMedia sx={{
        ...
        <Message>
          <Avatar sx={{ background: "#777" }}>{messages[0].name}</Avatar>
